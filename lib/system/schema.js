module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
      if (!('sk_author' in setting)) setting.sk_author = '© ᴢᴇᴏxʀ.ᴍᴅ'
      ...
      if (!('msg' in setting)) setting.msg = 'ʜɪ +tag 🪸\nI ᴀᴍ ᴀɴ ᴀᴜᴛᴏᴍᴀᴛᴇᴅ sʏsᴛᴇᴍ (ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ) ᴛʜᴀɴ ᴄᴀɴ ʜᴇʟᴘ ᴛᴏ ᴅᴏ sᴏᴍᴇᴛʜɪɴɢ, sᴇᴀʀᴄʜ ᴀɴᴅ ɢᴇᴛ ᴅᴀᴛᴀ / ɪɴғɪʀᴍᴀᴛɪᴏɴ ᴏɴʟʏ ᴛʜʀᴏᴜɢʜ ᴡʜᴀᴛsᴀᴘᴘ.\n\n◦ *ᴅᴀᴛᴀʙᴀsᴇ* : +db\n◦ *ʟɪʙʀᴀʀʏ* : ʙᴀɪʟᴇʏs v+version\n◦ *ɢɪᴛʜᴜʙ* : https://github.com/SlavMnzz\n◦ *sᴏᴜʀᴄᴇ* : https://github.com/neoxr/wbot\n\nɪғ ʏᴏᴜ ғɪɴᴅ ᴀɴ ᴇʀʀᴏʀ ᴏʀ ᴡᴀɴᴛ ᴛᴏ ᴜᴘɢʀᴀᴅᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ᴏᴡɴᴇʀ.'
      if (!isNumber(setting.style)) setting.style = 4
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/3d6daa2494d86f9190a46.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/EFglAMLeHhN1pQ7ASp5LsB'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         msg: 'ʜɪ +tag 🪸\nI ᴀᴍ ᴀɴ ᴀᴜᴛᴏᴍᴀᴛᴇᴅ sʏsᴛᴇᴍ (ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ) ᴛʜᴀɴ ᴄᴀɴ ʜᴇʟᴘ ᴛᴏ ᴅᴏ sᴏᴍᴇᴛʜɪɴɢ, sᴇᴀʀᴄʜ ᴀɴᴅ ɢᴇᴛ ᴅᴀᴛᴀ / ɪɴғɪʀᴍᴀᴛɪᴏɴ ᴏɴʟʏ ᴛʜʀᴏᴜɢʜ ᴡʜᴀᴛsᴀᴘᴘ.\n\n◦ *ᴅᴀᴛᴀʙᴀsᴇ* : +db\n◦ *ʟɪʙʀᴀʀʏ* : ʙᴀɪʟᴇʏs v+version\n◦ *ɢɪᴛʜᴜʙ* : https://github.com/SlavMnzz\n◦ *sᴏᴜʀᴄᴇ* : https://github.com/neoxr/wbot\n\nɪғ ʏᴏᴜ ғɪɴᴅ ᴀɴ ᴇʀʀᴏʀ ᴏʀ ᴡᴀɴᴛ ᴛᴏ ᴜᴘɢʀᴀᴅᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ᴏᴡɴᴇʀ.',
         style: 4,
         cover: 'https://telegra.ph/file/3d6daa2494d86f9190a46.jpg',
         link: 'https://chat.whatsapp.com/EFglAMLeHhN1pQ7ASp5LsB'
      }
   }
}